  ...
  describe('projects', () => {
    ...
    it('should save projects to localStorage', async () => {
      ...
      expect(localstorageSpy).toHaveBeenCalledWith(
        'projects',
        JSON.stringify([{ id: '1', name: 'test', status: 'active', notes: '' }]),
      );
    });
    ...
    it('should be able to insert a project', () => {
      ...
      expect(store.getAllProjects().value).toEqual([
        { id: '1', name: 'test', status: 'active', notes: '' },
      ]);
    });
    ...
    it('should be able to update a project', () => {
      ...
      expect(store.getAllProjects().value).toEqual([
        { id: '1', name: 'test', status: 'active', notes: 'test' },
      ]);
    });
    ...
    it('should be able to get a project by id', () => {
      ...
      expect(store.findProjectById('1').value).toEqual({
        id: '1',
        name: 'test',
        status: 'active',
        notes: '',
    ...
    it('should be able to find a project by predicate', () => {
      ...
      expect(store.findProject(project => project.id === '1').value).toEqual([
        { id: '1', name: 'test', status: 'active', notes: '' },
      ]);
    });
