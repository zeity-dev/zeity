...
<template>
  <div class="fixed bottom-0 inset-x-0 flex justify-center pointer-events-none">
    <div class="pointer-events-auto rounded-t-xl bg-default border border-default shadow-md">
      <nav class="relative flex items-center justify-center">
        <ul class="isolate min-w-0 flex items-center justify-between gap-2 px-3">
          <li v-for="button in horizontalMenu" :key="button.label" class="relative min-w-18 py-1">
            <ULink
